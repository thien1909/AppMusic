...
public class Dialog_insert_thu_vien_playlist extends AppCompatDialogFragment {
    ...
    ExampleDialogListenerthuvien exampleDialogListener;

    public Dialog_insert_thu_vien_playlist(ExampleDialogListenerthuvien exampleDialogListener){
        this.exampleDialogListener = exampleDialogListener;
    }
        ...
        btntao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tenthuvien.trim().length() < 1 || tenthuvien.trim().length() > 36){
                    ...
                    exampleDialogListener.apply(tenthuvien);
                    dismiss();
                }
            }
        });
