...
import com.example.hoanchinh.Adapter.PlaylistAdapter;
...
public class Fragment_Playlist extends Fragment {
    ...
    private void GetData() {
        ...
        callback.enqueue(new Callback<List<PlaylistModel>>() {
            ...
            public void onResponse(Call<List<PlaylistModel>> call, Response<List<PlaylistModel>> response) {
                ...
                playlistAdapter = new PlaylistAdapter(mangplaylist, new PlaylistAdapter.onClick() {
                    @Override
                    public void onclick(int position) {
                        Intent intent = new Intent(requireActivity(), DanhsachbaihatActivity.class);
    ...
    private void ShowDialogUpdate(){
        ...
        dialog_update_user.setListener(new Dialog_update_user.ExampleDialogListenerUpdateUser() {
            @Override
